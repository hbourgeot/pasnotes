...
<main class="w-full h-screen">
      ...
      <div class="lg:w-[50%] h-auto">
        ...
        <div>
          ...
          <ul class="flex flex-col gap-6">
            ...
            <li>
              • Capacitar a los estudiantes a fin de que afronten con éxito las
              exigencias específicas de los estudios profesionales de nivel
              superior.
            </li>
          </ul>
        </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <a href="#" class="mt-4 btn variant-filled-surface bg-pink-600"
              >Descargar Pensum</a
            >
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <a href="../lib/docs/PENSUM ADMINISTRACION BANCARIA Y FINANCIERA.docx" download="pensum.docx" class="mt-4 btn variant-filled-surface bg-pink-600"
              >Descargar Pensum</a
            >
          </div>
        </div>
  ...
  <footer class="bg-white py-10 w-full h-auto">
    <figure class="w-full h-auto mx-auto">
      <img src="{footer}" class="mx-auto" alt="" />
    </figure>
  </footer>
</main>
