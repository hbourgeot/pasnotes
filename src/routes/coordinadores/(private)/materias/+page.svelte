...
>
  ...
  <div class="w-11/12 lg:w-10/12">
    ...
    >
      ...
      >
        <Table source="{informaticaTable}" class="w-full mb-5 lg:mx-auto" />
      </div>
    </details>
    <details
      class="flex lg:w-2/5 w-3/4 mx-auto flex-col items-center justify-center my-4"
    >
      ...
      <div
        class="w-full mt-6 h-auto flex flex-wrap flex-col gap-6 [&>span]:w-full [&>span]:flex [&>span]:justify-between [&>span]:border-b [&>span]:border-gray-200"
      >
        <Table source="{tecnologiaAlimentosTable}" class="w-full mb-5 lg:mx-auto" />
      </div>
    </details>
    <details
      class="flex lg:w-2/5 w-3/4 mx-auto flex-col items-center justify-center my-4"
    >
      ...
      <div
        class="w-full mt-6 h-auto flex flex-wrap flex-col gap-6 [&>span]:w-full [&>span]:flex [&>span]:justify-between [&>span]:border-b [&>span]:border-gray-200"
      >
        <Table source="{comunicacionElectronicaTable}" class="w-full mb-5 lg:mx-auto" />
      </div>
    </details>
    <details
      class="flex lg:w-2/5 w-3/4 mx-auto flex-col items-center justify-center my-4"
    >
      ...
      <div
        class="w-full mt-6 h-auto flex flex-wrap flex-col gap-6 [&>span]:w-full [&>span]:flex [&>span]:justify-between [&>span]:border-b [&>span]:border-gray-200"
      >
        <Table source="{disenoGraficoTable}" class="w-full mb-5 lg:mx-auto" />
      </div>
    </details>
    <details
      class="flex lg:w-2/5 w-3/4 mx-auto flex-col items-center justify-center my-4"
    >
      ...
      <div
        class="w-full mt-6 h-auto flex flex-wrap flex-col gap-6 [&>span]:w-full [&>span]:flex [&>span]:justify-between [&>span]:border-b [&>span]:border-gray-200"
      >
        <Table source="{contabilidadCostosTable}" class="w-full mb-5 lg:mx-auto" />
      </div>
    </details>
    <details
      class="flex lg:w-2/5 w-3/4 mx-auto flex-col items-center justify-center my-4"
    >
      ...
      <div
        class="w-full mt-6 h-auto flex flex-wrap flex-col gap-6 [&>span]:w-full [&>span]:flex [&>span]:justify-between [&>span]:border-b [&>span]:border-gray-200"
      >
        <Table source="{administracionBancariaFinancieraTable}" class="w-full mb-5 lg:mx-auto" />
      </div>
    </details>
    <details
      class="flex lg:w-2/5 w-3/4 mx-auto flex-col items-center justify-center my-4"
    >
      ...
      <div
        class="w-full mt-6 h-auto flex flex-wrap flex-col gap-6 [&>span]:w-full [&>span]:flex [&>span]:justify-between [&>span]:border-b [&>span]:border-gray-200"
      >
        <Table source="{administracionEmpresarialTable}" class="w-full mb-5 lg:mx-auto" />
      </div>
    </details>
  </div>
</div>
