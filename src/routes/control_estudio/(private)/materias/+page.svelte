  ...
  <div class="w-11/12 lg:w-10/12">
    ...
    >
      ...
      >
        <p class="text-lg w-full text-center">Ver materias de:</p>
        <a
          href="/control_estudio/materias/2/1"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">1er semestre</a
        >
        <a
          href="/control_estudio/materias/2/2"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">2do semestre</a
        >
        <a
          href="/control_estudio/materias/2/3"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">3er semestre</a
        >
        <a
          href="/control_estudio/materias/2/4"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">4to semestre</a
        >
        <a
          href="/control_estudio/materias/2/5"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">5to semestre</a
        >
        <a
          href="/control_estudio/materias/2/6"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">6to semestre</a
        >
    ...
    >
      ...
      >
        <p class="text-lg w-full text-center">Ver materias de:</p>
        <a
          href="/control_estudio/materias/3/1"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">1er semestre</a
        >
        <a
          href="/control_estudio/materias/3/2"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">2do semestre</a
        >
        <a
          href="/control_estudio/materias/3/3"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">3er semestre</a
        >
        <a
          href="/control_estudio/materias/3/4"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">4to semestre</a
        >
        <a
          href="/control_estudio/materias/3/5"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">5to semestre</a
        >
        <a
          href="/control_estudio/materias/3/6"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">6to semestre</a
        >
    ...
    >
      ...
      >
        <p class="text-lg w-full text-center">Ver materias de:</p>
        <a
          href="/control_estudio/materias/4/1"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">1er semestre</a
        >
        <a
          href="/control_estudio/materias/4/2"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">2do semestre</a
        >
        <a
          href="/control_estudio/materias/4/3"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">3er semestre</a
        >
        <a
          href="/control_estudio/materias/4/4"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">4to semestre</a
        >
        <a
          href="/control_estudio/materias/4/5"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">5to semestre</a
        >
        <a
          href="/control_estudio/materias/4/6"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">6to semestre</a
        >
    ...
    >
      ...
      >
        <p class="text-lg w-full text-center">Ver materias de:</p>
        <a
          href="/control_estudio/materias/5/1"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">1er semestre</a
        >
        <a
          href="/control_estudio/materias/5/2"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">2do semestre</a
        >
        <a
          href="/control_estudio/materias/5/3"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">3er semestre</a
        >
        <a
          href="/control_estudio/materias/5/4"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">4to semestre</a
        >
        <a
          href="/control_estudio/materias/5/5"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">5to semestre</a
        >
        <a
          href="/control_estudio/materias/5/6"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">6to semestre</a
        >
    ...
    >
      ...
      >
        <p class="text-lg w-full text-center">Ver materias de:</p>
        <a
          href="/control_estudio/materias/6/1"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">1er semestre</a
        >
        <a
          href="/control_estudio/materias/6/2"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">2do semestre</a
        >
        <a
          href="/control_estudio/materias/6/3"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">3er semestre</a
        >
        <a
          href="/control_estudio/materias/6/4"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">4to semestre</a
        >
        <a
          href="/control_estudio/materias/6/5"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">5to semestre</a
        >
        <a
          href="/control_estudio/materias/6/6"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">6to semestre</a
        >
    ...
    >
      ...
      >
        <p class="text-lg w-full text-center">Ver materias de:</p>
        <a
          href="/control_estudio/materias/7/1"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">1er semestre</a
        >
        <a
          href="/control_estudio/materias/7/2"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">2do semestre</a
        >
        <a
          href="/control_estudio/materias/7/3"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">3er semestre</a
        >
        <a
          href="/control_estudio/materias/7/4"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">4to semestre</a
        >
        <a
          href="/control_estudio/materias/7/5"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">5to semestre</a
        >
        <a
          href="/control_estudio/materias/7/6"
          class="btn variant-filled bg-sky-700 m-auto"
          data-sveltekit-preload-data="hover">6to semestre</a
        >
